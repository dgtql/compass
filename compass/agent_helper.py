...
_CATEGORY_GLOBS: dict[str, list[str]] = {
    ...
    # Idea-exploration categories — populated by the idea-exploration template.
    "theme":          [".pipeline/docs/theme.json"],
    "survey":         ["corpus/research/survey.md"],
    "existing-memos": ["analysis/existing-memos.json"],
}
